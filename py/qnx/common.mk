...
CCFLAGS+=-fmessage-length=0 -DBOOST_FILESYSTEM_NARROW_ONLY  \
	-DBOOST_PYTHON_STATIC_LIB -fPIC
VFLAG_g=-gstabs+


#===== EXTRA_INCVPATH - a space-separated list of directories to search for include files.
EXTRA_INCVPATH+=$(PROJECT_ROOT)/../../canio2  \
	C:/python27_install/include/python2.7
#===== EXTRA_LIBVPATH - a space-separated list of directories to search for library files.
EXTRA_LIBVPATH+=C:/python27_install/lib
#===== EXTRA_SRCVPATH - a space-separated list of directories to search for source files.
EXTRA_SRCVPATH+=$(PROJECT_ROOT)/../
#===== LIBS - a space-separated list of library items to be included in the link.
LIBS+=-Bstatic boost_system boost_python boost_filesystem  \
	python2.7 m boost_thread -Bdynamic
...
define POST_BUILD
-@$(CP_HOST) $(BUILDNAME) $(PROJECT_ROOT)/../../bin_qnx/canio2.so
endef
